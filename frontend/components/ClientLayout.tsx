  ...
  return (
    <ThemeProvider>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1440px] flex-col px-3 py-3 sm:px-5 sm:py-5">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="space-y-0.5">
                <div className="flex items-baseline gap-2">
                  <div className="font-[family-name:var(--font-display)] text-[1.35rem] font-semibold tracking-tight text-amber-950 dark:text-amber-100">
                ...
                <div className="text-[11px] uppercase tracking-[0.34em] text-amber-900/40 dark:text-amber-400/40">
            ...
            <nav className="hidden items-center gap-2 md:flex">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className="rounded-full border border-transparent px-4 py-2 text-sm text-amber-900/65 transition hover:bg-amber-500/10 hover:border-amber-500/20 hover:text-amber-900 dark:text-amber-300/60 dark:hover:text-amber-200"
                >
                  {item.label}
                </Link>
              ))}
              <Link
                href="/how-it-works"
                className="rounded-full border border-amber-500/20 bg-amber-500/10 px-4 py-2 text-sm font-medium text-amber-700 transition hover:bg-amber-500/20 hover:border-amber-500/30 dark:text-amber-400 dark:border-amber-400/20 dark:bg-amber-400/10"
              >
                How It Works
              </Link>
              <ThemeToggle />
        ...
        <footer className="mt-auto px-4 pb-4 pt-3 text-center text-sm text-amber-900/45 dark:text-amber-400/40">
